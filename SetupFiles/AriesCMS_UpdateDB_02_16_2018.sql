...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite')
    BEGIN
        ...
        (
             ...
             sMerchantKey1 nvarchar(MAX),
             sMerchantKey2 nvarchar(MAX),
             sMerchantKey3 nvarchar(MAX),
             sMerchantKey4 nvarchar(MAX),
             sMerchantKey5 nvarchar(MAX),
             sMerchantKey6 nvarchar(MAX),
             sMerchantKey7 nvarchar(MAX),
             sMerchantKey8 nvarchar(MAX),
             sMerchantKey9 nvarchar(MAX),
        );
    END    
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sSupportEmailRequestID')
            ...
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey1')
            BEGIN        
              PRINT N'Adding Column sMerchantKey1 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey1 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey2')
            BEGIN        
              PRINT N'Adding Column sMerchantKey2 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey2 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey3')
            BEGIN        
              PRINT N'Adding Column sMerchantKey3 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey3 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey4')
            BEGIN        
              PRINT N'Adding Column sMerchantKey4 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey4 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey5')
            BEGIN        
              PRINT N'Adding Column sMerchantKey5 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey5 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey6')
            BEGIN        
              PRINT N'Adding Column sMerchantKey6 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey6 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey7')
            BEGIN        
              PRINT N'Adding Column sMerchantKey7 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey7 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey8')
            BEGIN        
              PRINT N'Adding Column sMerchantKey8 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey8 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSite' AND COLUMN_NAME = 'sMerchantKey9')
            BEGIN        
              PRINT N'Adding Column sMerchantKey9 to Table WebSite';
              ALTER TABLE WebSite ADD sMerchantKey9 nvarchar(MAX);
            END     
    END    
...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar')
    BEGIN
        ...
        (
             ...
             dEventCost11 float,
             dEventCost12 float,
             dSponserShipCost1 float,
             dSponserShipCost2 float,
             dSponserShipCost3 float,
             dSponserShipCost4 float,
             dSponserShipCost5 float,
             dSponserShipCost6 float,
             dSponserShipCost7 float,
             dSponserShipCost8 float,
             dSponserShipCost9 float,
        );
    END    
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'sQuestAnswerArray')
            ...
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost1')
            BEGIN        
              PRINT N'Adding Column dEventCost1 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost1 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost2')
            BEGIN        
              PRINT N'Adding Column dEventCost2 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost2 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost3')
            BEGIN        
              PRINT N'Adding Column dEventCost3 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost3 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost4')
            BEGIN        
              PRINT N'Adding Column dEventCost4 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost4 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost5')
            BEGIN        
              PRINT N'Adding Column dEventCost5 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost5 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost6')
            BEGIN        
              PRINT N'Adding Column dEventCost6 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost6 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost7')
            BEGIN        
              PRINT N'Adding Column dEventCost7 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost7 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost8')
            BEGIN        
              PRINT N'Adding Column dEventCost8 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost8 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost9')
            BEGIN        
              PRINT N'Adding Column dEventCost9 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost9 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost10')
            BEGIN        
              PRINT N'Adding Column dEventCost10 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost10 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost11')
            BEGIN        
              PRINT N'Adding Column dEventCost11 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost11 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dEventCost12')
            BEGIN        
              PRINT N'Adding Column dEventCost12 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dEventCost12 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost1')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost1 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost1 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost2')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost2 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost2 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost3')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost3 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost3 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost4')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost4 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost4 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost5')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost5 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost5 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost6')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost6 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost6 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost7')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost7 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost7 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost8')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost8 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost8 float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendar' AND COLUMN_NAME = 'dSponserShipCost9')
            BEGIN        
              PRINT N'Adding Column dSponserShipCost9 to Table WebSiteEventCalendar';
              ALTER TABLE WebSiteEventCalendar ADD dSponserShipCost9 float;
            END     
    END    
...
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteSponsors' AND COLUMN_NAME = 'sUserAvitarImgURL')
            ...
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteSponsors' AND COLUMN_NAME = 'bIsPaid')
            BEGIN        
              PRINT N'Adding Column bIsPaid to Table WebSiteSponsors';
              ALTER TABLE WebSiteSponsors ADD bIsPaid bit;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteSponsors' AND COLUMN_NAME = 'dtLastPaid')
            BEGIN        
              PRINT N'Adding Column dtLastPaid to Table WebSiteSponsors';
              ALTER TABLE WebSiteSponsors ADD dtLastPaid datetime;
            END     
    END    
...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors')
    BEGIN
        ...
        (
             ...
             bNegative bit,
             bHidden bit,
             sDataArray1 nvarchar(MAX),
             sDataArray2 nvarchar(MAX),
             sDataArray3 nvarchar(MAX),
             bIsPaid bit,
             dtLastPaid datetime,
        );
    END    
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors' AND COLUMN_NAME = 'bHidden')
            ...
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors' AND COLUMN_NAME = 'sDataArray1')
            BEGIN        
              PRINT N'Adding Column sDataArray1 to Table WebSiteEventCalendarSponsors';
              ALTER TABLE WebSiteEventCalendarSponsors ADD sDataArray1 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors' AND COLUMN_NAME = 'sDataArray2')
            BEGIN        
              PRINT N'Adding Column sDataArray2 to Table WebSiteEventCalendarSponsors';
              ALTER TABLE WebSiteEventCalendarSponsors ADD sDataArray2 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors' AND COLUMN_NAME = 'sDataArray3')
            BEGIN        
              PRINT N'Adding Column sDataArray3 to Table WebSiteEventCalendarSponsors';
              ALTER TABLE WebSiteEventCalendarSponsors ADD sDataArray3 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors' AND COLUMN_NAME = 'bIsPaid')
            BEGIN        
              PRINT N'Adding Column bIsPaid to Table WebSiteEventCalendarSponsors';
              ALTER TABLE WebSiteEventCalendarSponsors ADD bIsPaid bit;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarSponsors' AND COLUMN_NAME = 'dtLastPaid')
            BEGIN        
              PRINT N'Adding Column dtLastPaid to Table WebSiteEventCalendarSponsors';
              ALTER TABLE WebSiteEventCalendarSponsors ADD dtLastPaid datetime;
            END     
    END    
...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers')
    BEGIN
        ...
        (
             ...
             sPayMentStatusID nvarchar(MAX),
             sGroupID nvarchar(MAX),
             iGroupPayerID Int,
             sGroupPayerID nvarchar(MAX),
             sDataArray1 nvarchar(MAX),
             sDataArray2 nvarchar(MAX),
             sDataArray3 nvarchar(MAX),
        );
...
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sPaymentRef')
            ...
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'bIsPaid')
            BEGIN        
              PRINT N'Adding Column bIsPaid to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD bIsPaid bit;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'iPayMentStatusID')
            BEGIN        
              PRINT N'Adding Column iPayMentStatusID to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD iPayMentStatusID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sPayMentStatusID')
            BEGIN        
              PRINT N'Adding Column sPayMentStatusID to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD sPayMentStatusID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sGroupID')
            BEGIN        
              PRINT N'Adding Column sGroupID to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD sGroupID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'iGroupPayerID')
            BEGIN        
              PRINT N'Adding Column iGroupPayerID to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD iGroupPayerID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sGroupPayerID')
            BEGIN        
              PRINT N'Adding Column sGroupPayerID to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD sGroupPayerID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sDataArray1')
            BEGIN        
              PRINT N'Adding Column sDataArray1 to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD sDataArray1 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sDataArray2')
            BEGIN        
              PRINT N'Adding Column sDataArray2 to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD sDataArray2 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteEventCalendarUsers' AND COLUMN_NAME = 'sDataArray3')
            BEGIN        
              PRINT N'Adding Column sDataArray3 to Table WebSiteEventCalendarUsers';
              ALTER TABLE WebSiteEventCalendarUsers ADD sDataArray3 nvarchar(MAX);
            END     
    END    
...
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteMembers' AND COLUMN_NAME = 'sUserAvitarImgURL')
            ...
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteMembers' AND COLUMN_NAME = 'bIsPaid')
            BEGIN        
              PRINT N'Adding Column bIsPaid to Table WebSiteMembers';
              ALTER TABLE WebSiteMembers ADD bIsPaid bit;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteMembers' AND COLUMN_NAME = 'dtLastPaid')
            BEGIN        
              PRINT N'Adding Column dtLastPaid to Table WebSiteMembers';
              ALTER TABLE WebSiteMembers ADD dtLastPaid datetime;
            END     
    END    
...
GO
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent')
    BEGIN
        PRINT N'Creating Table WebSiteAlbumContent';
        CREATE TABLE WebSiteAlbumContent
        (
             [ID] Int PRIMARY KEY IDENTITY(1,1),
             iParentID Int,
             sParentID nvarchar(MAX),
             ...
             sSubject nvarchar(MAX),
             sAnswer nvarchar(MAX),
             sThumbNail nvarchar(MAX),
             dScore float,
             sContent nvarchar(MAX),
             iContentTypeID Int,
             sContentTypeID nvarchar(MAX),
             dViews float,
             dVotes float,
             sUserThumbNail nvarchar(MAX),
             iUserID Int,
...
ELSE    
    BEGIN    
        ...
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'iParentID')
            BEGIN        
              PRINT N'Adding Column iParentID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD iParentID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sParentID')
            BEGIN        
              PRINT N'Adding Column sParentID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sParentID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sControl')
            BEGIN        
              PRINT N'Adding Column sControl to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sControl nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dtDateCreated')
            BEGIN        
              PRINT N'Adding Column dtDateCreated to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dtDateCreated datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dtLastUpdated')
            BEGIN        
              PRINT N'Adding Column dtLastUpdated to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dtLastUpdated datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'iCreatedByID')
            BEGIN        
              PRINT N'Adding Column iCreatedByID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD iCreatedByID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sCreatedByID')
            BEGIN        
              PRINT N'Adding Column sCreatedByID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sCreatedByID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'iUpdatedByID')
            BEGIN        
              PRINT N'Adding Column iUpdatedByID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD iUpdatedByID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sUpdatedByID')
            BEGIN        
              PRINT N'Adding Column sUpdatedByID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sUpdatedByID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'iQuestID')
            BEGIN        
              PRINT N'Adding Column iQuestID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD iQuestID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sName')
            BEGIN        
              PRINT N'Adding Column sName to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sName nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sDescription')
            BEGIN        
              PRINT N'Adding Column sDescription to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sDescription nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sQuestID')
            BEGIN        
              PRINT N'Adding Column sQuestID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sQuestID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dtLastView')
            BEGIN        
              PRINT N'Adding Column dtLastView to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dtLastView datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sTags')
            BEGIN        
              PRINT N'Adding Column sTags to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sTags nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dtLastAnswer')
            BEGIN        
              PRINT N'Adding Column dtLastAnswer to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dtLastAnswer datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sSubject')
            BEGIN        
              PRINT N'Adding Column sSubject to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sSubject nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sAnswer')
            BEGIN        
              PRINT N'Adding Column sAnswer to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sAnswer nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sThumbNail')
            BEGIN        
              PRINT N'Adding Column sThumbNail to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sThumbNail nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dScore')
            BEGIN        
              PRINT N'Adding Column dScore to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dScore float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sContent')
            BEGIN        
              PRINT N'Adding Column sContent to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sContent nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'iContentTypeID')
            BEGIN        
              PRINT N'Adding Column iContentTypeID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD iContentTypeID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sContentTypeID')
            BEGIN        
              PRINT N'Adding Column sContentTypeID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sContentTypeID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dViews')
            BEGIN        
              PRINT N'Adding Column dViews to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dViews float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dVotes')
            BEGIN        
              PRINT N'Adding Column dVotes to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dVotes float;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sUserThumbNail')
            BEGIN        
              PRINT N'Adding Column sUserThumbNail to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sUserThumbNail nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'iUserID')
            BEGIN        
              PRINT N'Adding Column iUserID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD iUserID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sUserID')
            BEGIN        
              PRINT N'Adding Column sUserID to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sUserID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sUserScreenName')
            BEGIN        
              PRINT N'Adding Column sUserScreenName to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sUserScreenName nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'sOther')
            BEGIN        
              PRINT N'Adding Column sOther to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD sOther nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'dtDateOfPhoto')
            BEGIN        
              PRINT N'Adding Column dtDateOfPhoto to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD dtDateOfPhoto datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbumContent' AND COLUMN_NAME = 'bHidden')
            BEGIN        
              PRINT N'Adding Column bHidden to Table WebSiteAlbumContent';
              ALTER TABLE WebSiteAlbumContent ADD bHidden bit;
            END     
    END    
    
GO
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums')
    BEGIN
        PRINT N'Creating Table WebSiteAlbums';
        CREATE TABLE WebSiteAlbums
        (
             [ID] Int PRIMARY KEY IDENTITY(1,1),
             iParentID Int,
             sParentID nvarchar(MAX),
             ...
             sName nvarchar(MAX),
             sDescription nvarchar(MAX),
             dtLastPhotosAdded datetime,
             iPhotoCount Int,
             sHTMLDescription nvarchar(MAX),
             sThumbNail nvarchar(MAX),
             iViewOrder Int,
             dtDateOfAlbum datetime,
             bHidden bit,
             sAlbumContent nvarchar(MAX),
             sAlbumContent2 nvarchar(MAX),
             sAlbumContent3 nvarchar(MAX),
        );
    END    
ELSE    
    BEGIN    

        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'iParentID')
            BEGIN        
              PRINT N'Adding Column iParentID to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD iParentID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sParentID')
            BEGIN        
              PRINT N'Adding Column sParentID to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sParentID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sControl')
            BEGIN        
              PRINT N'Adding Column sControl to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sControl nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'dtDateCreated')
            BEGIN        
              PRINT N'Adding Column dtDateCreated to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD dtDateCreated datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'dtLastUpdated')
            BEGIN        
              PRINT N'Adding Column dtLastUpdated to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD dtLastUpdated datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'iCreatedByID')
            BEGIN        
              PRINT N'Adding Column iCreatedByID to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD iCreatedByID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sCreatedByID')
            BEGIN        
              PRINT N'Adding Column sCreatedByID to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sCreatedByID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'iUpdatedByID')
            BEGIN        
              PRINT N'Adding Column iUpdatedByID to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD iUpdatedByID Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sUpdatedByID')
            BEGIN        
              PRINT N'Adding Column sUpdatedByID to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sUpdatedByID nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sName')
            BEGIN        
              PRINT N'Adding Column sName to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sName nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sDescription')
            BEGIN        
              PRINT N'Adding Column sDescription to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sDescription nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'dtLastPhotosAdded')
            BEGIN        
              PRINT N'Adding Column dtLastPhotosAdded to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD dtLastPhotosAdded datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'iPhotoCount')
            BEGIN        
              PRINT N'Adding Column iPhotoCount to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD iPhotoCount Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sHTMLDescription')
            BEGIN        
              PRINT N'Adding Column sHTMLDescription to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sHTMLDescription nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sThumbNail')
            BEGIN        
              PRINT N'Adding Column sThumbNail to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sThumbNail nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'iViewOrder')
            BEGIN        
              PRINT N'Adding Column iViewOrder to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD iViewOrder Int;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'dtDateOfAlbum')
            BEGIN        
              PRINT N'Adding Column dtDateOfAlbum to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD dtDateOfAlbum datetime;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'bHidden')
            BEGIN        
              PRINT N'Adding Column bHidden to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD bHidden bit;
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sAlbumContent')
            BEGIN        
              PRINT N'Adding Column sAlbumContent to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sAlbumContent nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sAlbumContent2')
            BEGIN        
              PRINT N'Adding Column sAlbumContent2 to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sAlbumContent2 nvarchar(MAX);
            END     
        IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'WebSiteAlbums' AND COLUMN_NAME = 'sAlbumContent3')
            BEGIN        
              PRINT N'Adding Column sAlbumContent3 to Table WebSiteAlbums';
              ALTER TABLE WebSiteAlbums ADD sAlbumContent3 nvarchar(MAX);
            END     
    END    
